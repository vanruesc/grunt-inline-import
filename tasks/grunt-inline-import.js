/**
 * grunt-inline-import v0.1.0 build Dec 10 2017
...
function writeFile(modified, data, file) {
	...
	return !modified ? Promise.resolve("Nothing changed") : new Promise(function (resolve, reject) {
...
function registerInlineImportTask(grunt) {
...
module.exports = registerInlineImportTask;
